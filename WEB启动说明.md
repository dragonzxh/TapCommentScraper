...
2. **中文环境专用启动脚本（解决乱码问题）**：
   - 如果在Windows中文环境下遇到乱码问题
   - 双击运行 `启动评论爬虫_中文环境.bat` 文件
...
4. **Windows中文显示问题** - 如果命令行中显示乱码，请使用以下解决方案：
   - 使用专用的中文环境启动脚本：`启动评论爬虫_中文环境.bat`
   - 运行中文编码修复工具：`修复Windows中文乱码.bat`
   - 详细的修复步骤请参考 `Windows中文乱码修复指南.md` 文档 