...
# 直接启动自动处理脚本
echo "正在启动自动处理年龄验证并启动Web服务工具..."
chmod +x "自动处理年龄验证并启动服务.py"
python3 "自动处理年龄验证并启动服务.py"
...
echo "程序已完成执行，Web服务仍在后台运行"
echo "您可以继续访问 http://localhost:5000"
read -p "按回车键关闭此窗口..."
exit 0 